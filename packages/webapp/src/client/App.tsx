...
const App: React.FC = () => {
    ...
    // Create dynamic WebSocket URL based on current page URL
    ...
    }; const { sendMessage, connectionStatus } = useWebSocket(getWebSocketUrl(), {
                    ...
                    <Group justify="space-between" align="center">
                        ...
                        <Group>
                            ...
                            {workflowStatus && (
                                <Badge
                                    color={
                                        workflowStatus.status === 'running' ? 'blue' :
                                            workflowStatus.status === 'completed' ? 'green' :
                                                workflowStatus.status === 'error' ? 'red' : 'gray'
                                    }
                                    variant="filled"
                                >
                            ...
                            <Paper p="lg" withBorder>
                                <Stack gap="md">
                                    <Group justify="space-between">
                                        <Text size="lg" fw={500}>Workflow Progress</Text>
