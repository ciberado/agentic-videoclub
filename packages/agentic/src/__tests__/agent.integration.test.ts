...
describe('Video Recommendation Agent Integration Tests', () => {
  ...
  (shouldSkipIntegration ? test.skip : test)(
    ...
    30000,
  ); // Reduced timeout - should be much faster with optimizations

  (shouldSkipIntegration ? test.skip : test)(
    'should handle family-friendly input',
    async () => {
  ...
  (shouldSkipIntegration ? test.skip : test)(
    'should handle sci-fi specific requests',
    async () => {
